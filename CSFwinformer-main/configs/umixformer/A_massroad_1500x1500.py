_base_ = [
    '../_base_/models/segformer_mit-b0.py', '../_base_/datasets/massroad_1500x1500.py',
...
model = dict(
    ...
    decode_head=dict(
        ...
        in_channels=[32, 64, 160, 256],#默认num_layers=[2, 2, 2, 2],
        in_index=[0, 1, 2, 3],
        decoder_params=dict(embed_dim=128,
                            num_heads=[8, 5, 2, 1],
                            pool_ratio=[1, 2, 4, 8]),
    ),
    test_cfg=dict(mode='slide', crop_size=(1500, 1500), stride=(768, 768))
)
