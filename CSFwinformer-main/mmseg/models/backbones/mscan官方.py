...
def debug_pam():
    ...
    print("Output logits shape:", output_dict[0].shape)
    print("Output logits shape:", output_dict[1].shape)
    print("Output logits shape:", output_dict[2].shape)
    print("Output logits shape:", output_dict[3].shape)
